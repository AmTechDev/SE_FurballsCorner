...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    {	
        ...
        $query = "insert into users (user_id,firstname,lastname,email,address,phonenumber,password) values ('$user_id','$firstname','$lastname','$email','$address','$phonenumber','$hash')";
